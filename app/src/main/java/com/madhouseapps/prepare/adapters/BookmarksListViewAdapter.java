...
/**
 * Created by HEMANT on 18-01-2018.
 */
...
public class BookmarksListViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            if (subjectsList.get(i).toLowerCase().equals("biology")) {
                subText.setText("BIOLOGY");
                subText.setBackgroundColor(context.getResources().getColor(R.color.primary_biology));
